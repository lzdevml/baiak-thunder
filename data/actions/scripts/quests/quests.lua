config = {
    quests = {
        [46571] = {
            name = { active = false, value = "of the Crusader Helmet."},
            rewards = {
                {id = 2497, count = 1},
            },
    ...
    messages = {
        notExist = "This quest does not exist.",
        win = "You completed the quest %s.",
        notWin = "You have already completed this quest.",
        level = "You need to be level %d or higher to complete this quest.",
    },
}
