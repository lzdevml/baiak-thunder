local mounts = {
-- Config
	dollID = 9694, -- Change this to your dolls or items, item ID
 
	-- Main Window Messages (The first window the player sees)
	mainTitle = "Escolha uma Montaria!",
	mainMsg = "Escolha uma montaria para desbloquear.",
 
	-- Already Owned Window (The window that appears when the player already owns the addon)
	ownedTitle = "Whoops!",
	ownedMsg = "Você já possui esta montaria. Por favor, escolha outra.",
 
	-- No Doll in Backpack (The window that appears when the player doesnt have the doll in their backpack)
	dollTitle = "Whoops!",
	dollMsg = "A montaria precisa estar em sua mochila (backpack).",
-- End Config
 
		[1] = {name = "Widow Queen", ID = 1, type = 502},
