local outfits = {
    ...
    -- Mensagens da janela principal (A primeira janela que o jogador vê)
    mainTitle = "Escolha um outfit",
    mainMsg = "Você receberá ambos os addons, bem como o outfit que escolher.",

    -- Janela de item já obtido (A janela que aparece quando o jogador já possui o addon)
    ownedTitle = "Ops!",
    ownedMsg = "Você já possui este addon. Por favor, escolha outro.",

    -- Nenhum boneco na mochila (A janela que aparece quando o jogador não possui o boneco do outfit na mochila)
    dollTitle = "Ops!",
