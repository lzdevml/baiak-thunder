local config = {
    min = 20000,        -- Valor Mínimo da Aposta
    max = 100000000,    -- Valor Máximo da Aposta
    multiplyby = 2,     -- Quanto o valor será multiplicado caso o jogador ganhe
    automatic = true,   -- O NPC irá falar com o jogador automaticamente
    delay = 2,          -- Tempo em segundos em que o jogador poderá falar com o NPC novamente 
    position = {
        player = Position(422, 195, 7),  -- Posição que o jogador deve estar
    ...
    direction = {
        talking = DIRECTION_WEST,  -- Posição na qual estará o NPC caso esteja conversando
        stopped = DIRECTION_SOUTH  -- Posição na qual estará o NPC caso esteja parado
    }
}
