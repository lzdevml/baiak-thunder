local config = {
    first_room_pos = {x = 31, y = 1208, z = 4}, -- Position of the first room (row 1 column 1)
    distX = 18, -- Distance in X between each room (within the same row)
    distY = 17, -- Distance in Y between each room (within the same column)
    rX = 9, -- Number of columns
    rY = 4 -- Number of rows
}
